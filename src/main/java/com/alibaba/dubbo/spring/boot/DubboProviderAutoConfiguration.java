...
public class DubboProviderAutoConfiguration extends DubboCommonAutoConfiguration
	...
	private void initProviderBean(String beanName, Object bean) throws Exception {
		...
		serviceConfig.setApplication(
				this.parseApplication(application, this.properties, environment, beanName, "application", application));
		...
		serviceConfig
				.setRegistries(this.parseRegistries(registries, this.properties, environment, beanName, "registry"));
		...
		serviceConfig
				.setMonitor(this.parseMonitor(monitor, this.properties, environment, beanName, "monitor", monitor));
